...
clc;
clear;
D3=xlsread('Evaporation_rate.xlsx',4);   %read for time,contact radius, height, heat flux
[r3,c3]=size(D3); 
T_time=zeros(r3,1);
...
Ts=60+273.15;                % substrate temperature
...
k=0.7;                      %evaporation part from the base
for it = 1:1:20
