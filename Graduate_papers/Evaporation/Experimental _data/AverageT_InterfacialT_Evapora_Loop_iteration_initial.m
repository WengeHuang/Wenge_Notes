...
clc;
clear;
D3=xlsread('Evaporation_rate.xlsx',7);   %read for time,contact radius, height, heat flux
[r3,c3]=size(D3); 
T_time=zeros(r3,1);
...
Ts=90+273.15;                % substrate temperature
...
kkk=0;
for k=0.7:0.01:0.8         %evaporation part from the base
kkk=kkk+1;    
for it = 1:1:5
